...
public class DataMessage {
	...
	public void setMessageLength(int messageLength) {
		...
		this.len = Utility.intToByteArray(messageLength);
	}

	public void setMessageLength(byte[] len) {

		Integer l = Utility.byteArrayToInt(len);
	...
	public String toString() {
		String str = null;
		try {
			str = "[DataMessage] : Message Length - " + this.messageLength + ", Message Type - " + this.messageType
	...
	public static DataMessage decodeMessage(byte[] Message) {
		...
		try {
			...
			len = Utility.byteArrayToInt(msgLength);
